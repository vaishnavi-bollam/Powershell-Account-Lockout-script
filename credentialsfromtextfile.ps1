...
$credentialsFilePath = "C:\path\to\your\credentials.txt"

$credentials = Get-Content $credentialsFilePath
$serviceAccountUsername = $credentials[0]
$serviceAccountPassword = ConvertTo-SecureString $credentials[1] -AsPlainText -Force
